    ...
    <div>
      ...
      <Pagination className="py-10">
        <PaginationContent className="gap-x-3 flex">
          ...
          {page > 1 && (
            <>
              <PaginationItem
                ...
                className={`hover:bg-[#e99e26] hover:text-[#000] cursor-pointer  ${
              ...
              {page > 2 && (
                <PaginationItem className="hover:bg-[#e99e26] ">
                  <PaginationEllipsis />
                </PaginationItem>
              )}
              {page > 2 && (
          ...
          <PaginationItem
            className={`active hover:bg-[#e99e26] hover:text-[#000] cursor-pointer ${
          ...
          {page < movies.length && (
            <>
              ...
              {page < movies.length - 1 && (
                <PaginationItem className="hover:bg-[#e99e26] cursor-pointer hover:text-[#000]">
                  <PaginationEllipsis />
                </PaginationItem>
              )}
              {page < movies.length - 1 && (
                <PaginationItem
                  ...
                  className={`hover:bg-[#e99e26] cursor-pointer hover:text-[#000] ${
